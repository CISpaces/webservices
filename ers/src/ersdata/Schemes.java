...
private String getString(){
	...
	//at the moment we do not read a file I would rather avoid that
	//first try to read it at the code location if not there return our string!
	...
	try{
		FileReader file = new FileReader(ci_path+"/code/config/argSchemesJSON.txt");
