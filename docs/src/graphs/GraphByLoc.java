...
public class GraphByLoc {
	public GraphByLoc(){
		
	}

	public void goBuildGraphByLoc(HttpServletRequest request, HttpServletResponse response) throws IOException {
		String title="# Responses by location";
		if(title==null){
			title="numByLoc";
		}
		int x,y;
	    ...
	    /* Step - 1: Define the data for the bar chart  */
	 	...
	 	if(!resp.isEmpty()){
	    LinkedTreeMap data=(LinkedTreeMap) resp.get("numByLoc");
	    LinkedTreeMap ratiomap=(LinkedTreeMap) resp.get("ratioByLoc");
