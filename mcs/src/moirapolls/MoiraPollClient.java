...
public class MoiraPollClient {
  ...
  */
	...
	private int m_port;
	public MoiraPollClient(boolean p){
		log=Logger.getLogger(getClass().getName());
		PRINT=p;
	}
 
	
	public String ConnectToEvaluate(int m_port2, String host, String path){
	...
	//	System.out.println("got 5");
		HttpProcessor httpproc = HttpProcessorBuilder.create()
	        ...
	        //     nameValuePairs.add(new BasicNameValuePair("jsonInput", json));
