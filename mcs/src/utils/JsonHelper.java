...
public ArrayList convertInputArray(String json) {
	 ArrayList map=new ArrayList();
	 Gson gson = new Gson();
try{
     //JSR Fix incompatiple types
	 //map = gson.fromJson(json, HashMap.class);
     map = gson.fromJson(json, ArrayList.class);
}catch(Exception e){
	 log.log(Level.SEVERE,"Exception Not a JSON string",e); 
}
	return  map;
}
...
public String convertInputJson(ArrayList input) {
	Gson gson = new GsonBuilder()
			 //   .setPrettyPrinting()
			    .disableHtmlEscaping()
			    .create();
